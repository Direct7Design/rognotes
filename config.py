# Name of the blog
blog_name = 'rog\'s notes'

# Your name (used for copyright info)
author_name = 'roger'

# (Optional) slogan
slogan = 'stuff that matters'
  
# The hostname this site will primarially serve off (used for Atom feeds)
host = 'rognotes.appspot.com'
...
sidebars = [
  ('Other', [
    '<a href="http://twitter.com/rogcg">twitter</a>',
    '<a href="https://plus.google.com/107284324232312775819/about">google+</a>',
    '<a href="http://github.com/rogcg">projects</a>',
    '<a href="http://soundcloud.com/rogcg">soundcloud</a>',
  ]),
]
